<?php
$arr_list = ["PEMULASARAN JENAZAH", "KESLING", "AMBULANCE", "LAUNDRY", "GUDANG UMUM", "FASMED", "K3RS", "IPSRS", "B3", "GIZI", "PARKIR", "PELAYANAN PELANGAN", "ADMISI PENDAFTARAN", "IGD", "LABORATORIUM", "RADIOLOGI", "INSEMINASI", "FARMASI", "POLIKLINIK", "ADMISI RAWAT JALAN & KASIR", "POLI EKSEKUTIF", "HEMODIALISA", "REHABILITASI MEDIK", "ICU", "PICU", "HCU", "NICU", "CSSD", "IBS", "GUDANG FARMASI", "PERKANTORAN - MANAJEMEN & DIREKSI", "JKN - MEDREK", "RUANG BERSALIN(VK)", "PERINATOLOGI", "RANAP LT.8", "RANAP LT.9", "RANAP LT.10", "RANAP LT.11", "RANAP LT.12"];
?>
<!doctype html>
<html lang="en">
    ...
    <div class="container">
        <main>
            <div class="py-5 text-center">
                ...
                <p class="lead">dibawah ini merupakan form absensi kegiatan telusur individu</p>
            </div>
                    ...
                    <form class="needs-validation" novalidate>
                        <div class="row g-3">
                            <div class="col-sm-12">
                                ...
                                <select name="namalengkap" id="namalengkap" class="form-select nama" required>
                                    <option value=""></option>
                                </select>
    ...
    <script>
        $(function() {
            $('#simpanDataBtn').on("click", function(e) {
                ...
                if (namalengkap == "") {
                    swal('Peringatan!', 'Nama Lengkap Belum diisi/dipilih', 'warning');
                    return false;
                }
                let unitkerja = $('#unitkerja').val();
                if (unitkerja == "") {
                    swal('Peringatan!', 'Unit Kerja / Instalasi Belum diisi/dipilih', 'warning');
                    return false;
                }
            ...
            $(".nama").select2({
                ajax: {
                    url: "ajax_data/cari_data_petugas.php",
                    dataType: 'json',
                    delay: 250,
